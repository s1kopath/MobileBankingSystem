...
public class Withdrawl extends JFrame implements ActionListener{
    ...
    Withdrawl(String pin){
        ...
        l1 = new JLabel("MAXIMUM CASHOUT IS BDT 10,000");
        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    JOptionPane.showMessageDialog(null, "Please enter the Amount to you want to cash out");
                }else{
                    Conn c1 = new Conn();
                    ...
                    JOptionPane.showMessageDialog(null, "BDT "+amount+" Withdrawal Successfully");
